...
//token - it is a string of characters that is used to authenticate a user
//baseURL - it is the base URL for the API
//Content-Type - it is a header that is used to indicate the media type of the resource
